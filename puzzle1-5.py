...
coords = {}
for x in f:  #for every line
   begin = x.split()[0]
   beginx = int(begin.split(",")[0])
   beginy = int(begin.split(",")[1])
   ...
   if beginx == endx or beginy == endy:
      while beginx != endx or beginy != endy:
         ...
         if beginx != endx:
            if beginx > endx: #if the begin 8 and end is 5
               begin = str(beginx-1)+","+str(beginy)
               beginx -= 1
            else:
               begin = str(beginx+1)+","+str(beginy)
               beginx += 1
         else:
            if beginy > endy: #if the begin 8 and end is 5
               begin = str(beginx)+","+str(beginy-1)
               beginy -= 1
            else:
               begin =  str(beginx)+","+str(beginy+1)
               beginy += 1
